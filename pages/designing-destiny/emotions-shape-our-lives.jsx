...
const emotions = () =>  {
  ...
  const seoContent = {
    metaTitle: "How Emotions Shape Our Lives I Develop Emotional Intelligence Through Heartfulness"
  };
...
return(
  <div>
    ...
    <div className={Styles.top_div}>
      <div className={Styles.top_inside_div}>
        <div className={`mt-5 ${Styles.top_heading}`}>
          <h1>Emotions Shape Our Lives</h1>
          <h4><em>Designing Destiny, the Heartfulness Way</em></h4>
        </div>
    ...
    <div className={`text-center p-3 ${Styles.youtube_box}`}>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/Bjax-vyokU4" title="Dealing With Depression And Anger Issues | Joshua Pollock | Heartfulness | Daaji" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen />
    </div>
    <div className={` container col-lg-12 ${Styles.down_div}`}>
      ...
      <div className='text-center'>
        <img src="https://hfn-strapi-bucket.s3.ap-south-1.amazonaws.com/chakras_3b0cc2cf6e.png?updated_at=2022-11-23T08:10:16.028Z" alt='' />
      </div>
      <p>
    ...
    <div className="text-center pt-3 pb-3">
      <div className="container">
        <small className="pt-2">
          ...
          and Noah with the wish that all children know the blessing of growing
